        ...
        <>
            <div class="fixed inset-0 bg-gray-200/40 backdrop-blur-sm flex items-center justify-center z-50">
                ...
                <div class="relative bg-white rounded-2xl shadow-lg w-[500px] p-8 text-center">
                    ...
                    <img src={resturent} alt="Customer App" class="w-40 mx-auto mb-4" />


                    <h2 class="text-2xl font-semibold mb-2">Restaurant App</h2>


                    <p class="text-gray-600 text-sm mb-6">
                    Empowers restaurants to manage orders, update menus, track earnings, and communicate with delivery agents—all in one place.
                    </p>
