...
<div class="fixed inset-0 bg-gray-200/40 backdrop-blur-sm flex items-center justify-center z-50">
  ...
  <div class="relative bg-white rounded-2xl shadow-lg w-[500px] p-8 text-center">
    ...
    <img src={customerapp} alt="Customer App" class="w-40 mx-auto mb-4" />

   
    <h2 class="text-2xl font-semibold mb-2">Customer App</h2>

  
    <p class="text-gray-600 text-sm mb-6">
      An intuitive and modern interface for customers to browse menus, 
      place orders, track deliveries, and make secure payments in real-time.
    </p>
